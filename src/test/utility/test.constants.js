...
export default{APPROVE_APPOINTMENT,CANCELLED_APPOINTMENT,SEND_VERIFICATION,SEND_REGISTER_CODE,SAMPLE_DATA,CREATE_PRESCRIPTION,SEND_OTP,SEND_PRESCRIPTION}