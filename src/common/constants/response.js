...
export const AUTH_RESPONSES = {
  ...
  PERSONAL_DELETE_SUCCESSFULLY:new MessageHandler(SUCCESS,PERSONAL_DELETE_SUCCESSFULLY),
  FAMILY_UPDATE_SUCCESSFULLY:new MessageHandler(SUCCESS,FAMILY_UPDATE_SUCCESSFULLY),
  FAMILY_DELETE_SUCCESSFULLY:new MessageHandler(SUCCESS,FAMILY_DELETE_SUCCESSFULLY),
  DISEASE_UPDATE_SUCCESSFULLY:new MessageHandler(SUCCESS,DISEASE_UPDATE_SUCCESSFULLY),
  DISEASE_DELETE_SUCCESSFULLY:new MessageHandler(SUCCESS,DISEASE_DELETE_SUCCESSFULLY),
  DOCUMENT_UPDATE_SUCCESSFULLY:new MessageHandler(SUCCESS,DOCUMENT_UPDATE_SUCCESSFULLY),
  DOCUMENT_DELETE_SUCCESSFULLY:new MessageHandler(SUCCESS,DOCUMENT_DELETE_SUCCESSFULLY),
  FAILED_TO_RETRIVE:new MessageHandler(BAD_REQUEST,FAILED_TO_RETRIVE),
  CANNOT_DELETE_SUPERADMIN:new MessageHandler(BAD_REQUEST,CANNOT_DELETE_SUPERADMIN),
  LOGIN_CREDENTIAL:new MessageHandler(BAD_REQUEST,LOGIN_CREDENTIAL),
  APPOINTMENT_BOOKED:new MessageHandler(BAD_REQUEST,APPOINTMENT_BOOKED),
  PATIENT_ID_NOT_EXIST:new MessageHandler(BAD_REQUEST,PATIENT_ID_NOT_EXIST)
};
